...
<div class="bg-white p-5 rounded-5 text-secondary shadow" style="width: 45rem">
            ...
            <div class="imagen d-flex justify-content-center ">
                <img src="imagenes/logo.jpeg" class="logo" style="height: 9rem; border-radius: 20%; margin-bottom: 2rem; " alt="Avatar Image">
            </div>

            <h1 class="text-center text-dark fs-1 fw-bold">Registrarse</h1>
            <!--Inserta titulo-->
            ...
            <div class="d-flex gap-1 justify-content-center mt-1"><input class="btn btn-danger text-white mt-4 fw-semibold shadow-sm" style="width: 80%" type="submit" name="validar" value="Registrarme"></div>

            <input type="hidden" name="MM_insert" value="formreg">

            <a href="index.html" class="text-decoration-none text-dark fw-semibold fst-italic" style="font-size: 0.9rem;">VOLVER</a>
