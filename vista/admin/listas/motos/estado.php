...
<nav class="navbar navbar-expand-md">
    ...
    <div class=" d-flex justify-content-center align-items-center ">
        <div class="main-container rounded-5 text-secondary" style="width: 70rem">
            ...
            <h2 class="text-center text-dark fs-1 fw-bold" style="margin-right: 25%;">Listado de Estados</h2>
            <br>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="./crear_est.php">
                            <button type="submit" class="btn btn-dark m-1 shadow-sm">CREAR ESTADO</button>
                    </form>
                </div>
            </div>
            <br><br><br>
            ...
            <table style="border:#000 solid 1px">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['id_estado']?></td>

                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['estado']?></td>

                            <td style="background-color: #DCD6D6">
                                <form action= "./edit_est.php" method="get">
                                    <input type="hidden" name="actu" value= "<?=$sq['id_estado']?>">
                                    <button type= "submit" class="btn btn-dark text-white w-70 mt-4 fw-semibold shadow-sm">Editar</button>
                                </form>

                            </td>
                            <td style="background-color: #DCD6D6">
                                <form action= "./eliminar_est.php" method="get">
                                    <input type="hidden" name="borrar" value= "<?=$sq['id_estado']?>">
